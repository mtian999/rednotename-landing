export const FAQS_EN = [
  ...
  {
    title: "Who is the RedNote Chinese Name Generator for?",
    content:
      "This tool is for non-Chinese speakers who are interested in Chinese culture and want a unique, memorable, and fashionable Chinese name for their RedNote accounts. It is designed to be Easy for anyone to use.",
  },
  {
    title: "How does the RedNote Chinese Name Generator work?",
    content:
      "Users input their name or nickname (non-Chinese), select their gender (optional), and choose their preferred style (optional). The tool then generates multiple Chinese name options with pinyin and brief explanations. It is more efficient than searching online for a name.",
  },
  {
    title: "Can I customize the generated names?",
    content:
      "Yes, the tool offers various customization options, including different name styles such as cute, artistic, trendy, and ancient styles. You can also choose preferred characters and meanings. This helps you Optimize your name selection.",
  },
  {
    title: "Is there any way to save or share my generated names?",
    content:
      "Yes, the tool allows you to save your favorite names and share them on social media. This is very Practical, helping you select and share your perfect RedNote chinese name.",
  },
  {
    title:
      "How does the generator ensure the names are culturally appropriate?",
    content:
      "The tool uses a database of common Chinese characters and words, combined with semantic analysis to generate meaningful and culturally appropriate names. It also considers user-selected styles to match the RedNote platform’s aesthetic. It is designed to be Effective for all users.",
  },
];
...
export const FAQS_ZH = [
  {
    title: "什么是小红书中文网名生成器？",
    content:
      "小红书中文网名生成器是一款专为非中文母语用户设计的工具，旨在帮助他们在小红书上创建时尚且符合中国文化习惯的中文网名。它使用起来非常Ready to use和便捷。",
  },
  {
    title: "小红书中文网名生成器适合哪些用户？",
    content:
      "这款工具适合对中国文化感兴趣，并且希望拥有一个独特、易记、时尚中文网名的非中文母语用户，让他们在小红书上更受欢迎。它设计的非常Easy上手。",
  },
  {
    title: "小红书中文网名生成器是如何工作的？",
    content:
      "用户输入他们的姓名或昵称（非中文），选择性别（可选），并选择偏好的风格（可选）。然后，该工具会生成多个带有拼音和简要解释的中文网名选项。这比在网上搜索名字更more efficient。",
  },
  {
    title: "我可以自定义生成的网名吗？",
    content:
      "是的，该工具提供了多种自定义选项，包括可爱风、文艺风、潮流风和古风等不同的网名风格。您还可以选择喜欢的汉字和含义。这可以帮助你Optimize你的名字选择。",
  },
  {
    title: "是否有任何方法可以保存或分享我生成的网名？",
    content:
      "是的，该工具允许您保存您喜欢的网名并在社交媒体上分享它们。这非常Practical，可以帮助您选择和分享您完美的小红书chinese name。",
  },
  {
    title: "该生成器如何确保网名符合文化习惯？",
    content:
      "该工具使用包含常用汉字和词语的数据库，结合语义分析来生成有意义且符合文化习惯的网名。它还会考虑用户选择的风格，以匹配小红书平台的审美。它旨在对所有用户都Effective。",
  },
];
